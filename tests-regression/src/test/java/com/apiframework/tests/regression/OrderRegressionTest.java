...
@RetrySetting(maxAttempts = 3, delayMs = 500)
public class OrderRegressionTest extends BaseApiTest {
    ...
    @Test
    @RetrySetting(maxAttempts = 4, delayMs = 1000)
